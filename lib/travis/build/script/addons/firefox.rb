        ...
        class Firefox
          ...
          def before_install
            @script.fold('install_firefox') do |script|
              ...
              script.cmd "sudo -n mkdir -p /usr/local/firefox-#{@firefox_version}", assert: false
              script.cmd "sudo -n chown -R travis /usr/local/firefox-#{@firefox_version}", assert: false
              ...
              script.cmd "sudo -n ln -sf /usr/local/firefox-#{@firefox_version}/firefox/firefox /usr/local/bin/firefox", assert: false
              script.cmd "sudo -n ln -sf /usr/local/firefox-#{@firefox_version}/firefox/firefox-bin /usr/local/bin/firefox-bin", assert: false
