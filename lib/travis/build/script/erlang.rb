    ...
    class Script
      class Erlang < Script
        ...
        private
          ...
          def activate_file
            "${TRAVIS_BUILD_HOME}/otp/#{otp_release}/activate"
          end
          ...
          def install_erlang(release)
            ...
            sh.cmd "wget -o ${TRAVIS_BUILD_HOME}/erlang.tar.bz2 ${archive_url}"
            ...
            sh.cmd "echo '#{release} ${TRAVIS_BUILD_HOME}/otp/#{release}' >> ~/.kerl/otp_builds", echo: true
            sh.raw "rm -f ${TRAVIS_BUILD_HOME}/erlang.tar.bz2"
          end
      end
    end
  end
