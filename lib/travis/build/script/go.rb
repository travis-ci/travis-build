    ...
    class Script
      class Go < Script
        ...
        def setup
          ...
          sh.cmd "tar -czf ${TRAVIS_TMPDIR}/src_archive.tar.gz -C ${TRAVIS_BUILD_DIR} . && tar -xzf ${TRAVIS_TMPDIR}/src_archive.tar.gz -C ${TRAVIS_HOME}/gopath/src/#{go_import_path}", assert: false, timing: false
