require 'travis/build/script/stages/addon'
require 'travis/build/script/stages/base'
require 'travis/build/script/stages/builtin'
require 'travis/build/script/stages/custom'
require 'travis/build/script/stages/result'
