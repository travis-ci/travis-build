  ...
  module Build
    class Addons
      class Sonarqube < Base
        ...
        SCANNER_CLI_VERSION = "2.7-build314"
        SCANNER_HOME = "$HOME/.sonarscanner"
        #SCANNER_CLI_REPO = "http://repo1.maven.org/maven2"
        SCANNER_CLI_REPO = "https://repox.sonarsource.com/sonarsource-public-releases"
        ...
        def skip(reason)
          sh.fold 'sonarqube.skip' do
            sh.echo "Skipping SonarQube Scan because " + SKIP_MSGS[reason]
