        ...
        def apply
          sh.fold 'git.checkout' do
            ...
            sh.file '~/.ssh/known_hosts', <<~EOF, append: true, echo: false
              ...
              git-k8s-staging-frank.assembla.app ssh-rsa 
              git-k8s-staging-frank.assembla.app ecdsa-sha2-nistp256 AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBHJ4vnKVPkC8Krj4R5V07HLvzUsD2IDujxMQI+6D5G21sq+LAABEeQj+dRzC/OPYSIdzIEE/21fHJlInXDqujyQ=
            EOF
            clone_or_fetch
            sh.cd dir
