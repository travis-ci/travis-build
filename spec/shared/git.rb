shared_examples_for 'a git repo' do
  ...
  describe 'using clone' do
    ...
    it 'clones the git repo' do
      ...
      is_expected.to run cmd, echo: true, log: true, assert: true, timeout: timeout, retry: true
    end
    ...
    it 'changes to the git repo dir' do
      is_expected.to run 'cd travis-ci/travis-ci', timeout: false
    end
    ...
    it 'fetches a ref if given' do
      ...
      is_expected.to run cmd, echo: true, log: true, assert: true, timeout: timeout
    end
