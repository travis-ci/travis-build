...
describe Travis::Build::Script::Go do
  ...
  it 'sets the default go version if not :go config given' do
    is_expected.to travis_cmd 'gvm use go1.3.3', echo: true, assert: true, timing: true
  end
  ...
  {'1.1' => 'go1.1', '1' => 'go1.3.3', '1.3' => 'go1.3.3', '1.2' => 'go1.2.2', '1.0' => 'go1.0.3', '1.2.2' => 'go1.2.2', '1.0.2' => 'go1.0.2'}.each do |version_alias,version|
