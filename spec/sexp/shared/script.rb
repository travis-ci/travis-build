shared_examples_for 'a build script sexp' do
  ...
  it 'sets environment variables from settings' do
    ...
    should include_sexp [:echo, 'Setting environment variables from repository settings', ansi: :green]
    should_not include_sexp [:echo, 'Setting environment variables from .travis.yml', ansi: :green]
  end
  ...
  it 'sets environment variables from config' do
    ...
    should_not include_sexp [:echo, 'Setting environment variables from repository settings', ansi: :green]
    should include_sexp [:echo, 'Setting environment variables from .travis.yml', ansi: :green]
  end
  ...
  it 'sets PS4 to fix an rvm issue' do
    should include_sexp [:export, ['PS4', '+ '], echo: true]
  end
  ...
  describe 'config result' do
    ...
    let(:terminate)      { [:cmd, 'travis_terminate 2'] }
