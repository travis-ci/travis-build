...
describe Travis::Build::Script::Csharp, :sexp do
  ...
  describe 'configure' do
    it 'sets up package repository' do
      should include_sexp [:cmd, 'sudo apt-key adv --keyserver pgp.mit.edu --recv-keys 3FA7E0328081BFF6A14DA29AA6A19B38D3D831EF']
  ...
  describe 'script' do
    ...
    it 'builds specified solution' do
      data[:config][:solution] = 'foo.sln'
      should include_sexp [:cmd, 'xbuild foo.sln', echo: true, timing: true]
    end
  end
end
