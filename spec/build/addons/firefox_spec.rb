...
describe Travis::Build::Addons::Firefox, :sexp do
  ...
  context 'given a valid version string' do
    ...
    it { should include_sexp [:mkdir, '${TRAVIS_BUILD_HOME}/firefox-20.0', recursive: true] }
    it { should include_sexp [:chown, ['travis', '${TRAVIS_BUILD_HOME}/firefox-20.0'], recursive: true] }
    it { should include_sexp [:cd, '${TRAVIS_BUILD_HOME}/firefox-20.0', stack: true] }
    ...
    it { should include_sexp [:export, ['PATH', "${TRAVIS_BUILD_HOME}/firefox-20.0/firefox:$PATH"], echo: true] }
    it { should include_sexp [:cd, :back, stack: true] }
  end

  context 'given a valid version "50.0b6"' do
    let(:config) { '50.0b6' }
    it { should include_sexp [:export, ['PATH', "${TRAVIS_BUILD_HOME}/firefox-50.0b6/firefox:$PATH"], echo: true] }
  end

  context 'given a valid version "latest"' do
    let(:config) { 'latest' }
    it { should include_sexp [:export, ['PATH', "${TRAVIS_BUILD_HOME}/firefox-latest/firefox:$PATH"], echo: true] }
  ...
  context 'given a valid version "latest-beta"' do
    ...
    it { should include_sexp [:export, ['PATH', "${TRAVIS_BUILD_HOME}/firefox-latest-beta/firefox:$PATH"], echo: true] }
  end

  context 'given a valid version "latest-esr"' do
    let(:config) { 'latest-esr' }
    it { should include_sexp [:export, ['PATH', "${TRAVIS_BUILD_HOME}/firefox-latest-esr/firefox:$PATH"], echo: true] }
  end
  ...
  context 'given a valid version "latest-unsigned"' do
    ...
    it { should include_sexp [:export, ['PATH', "${TRAVIS_BUILD_HOME}/firefox-latest-unsigned/firefox:$PATH"], echo: true] }
  end
  ...
  context 'given a invalid version string' do
    ...
    it { should_not include_sexp [:export, ['PATH', "${TRAVIS_BUILD_HOME}/firefox-20.0/firefox:$PATH"], echo: true] }
  end
end
