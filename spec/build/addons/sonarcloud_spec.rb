...
describe Travis::Build::Addons::Sonarcloud, :sexp do
  ...
  it_behaves_like 'compiled script' do
    let(:code) { ['curl --retry 2 -sSLo "$HOME/.sonarscanner/sonar-scanner.zip" "http://repo1.maven.org/maven2/org/sonarsource/scanner/cli/sonar-scanner-cli/2.8/sonar-scanner-cli-2.8.zip"'] }
  end
