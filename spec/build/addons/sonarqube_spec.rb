...
describe Travis::Build::Addons::Sonarqube, :sexp do
  ...
  it_behaves_like 'compiled script' do
    let(:code) { ['curl -sSLo $HOME/.sonarscanner/sonar-scanner.zip'] }
  end
  ...
  describe 'scanner installation' do
    ...
    it { should include_sexp [:export, ['MAVEN_OPTS', "\"$MAVEN_OPTS -Dsonar.host.url=https://nemo.sonarqube.org\""], {:echo=>true}] }
