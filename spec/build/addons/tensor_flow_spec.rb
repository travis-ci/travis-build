...
describe Travis::Build::Addons::TensorFlow, :sexp do
  ...
  context 'when version is valid' do
    ...
    it { should include_sexp [:cmd, "pip install --trusted-host pip.cache.travis-ci.com -i http://pip.cache.travis-ci.com/root/pypi/+simple/ 'tensorflow==2.11' --force-reinstall"] }
  end
end
